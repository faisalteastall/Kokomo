...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="app-assets/images/fevicon.png">
    ...
    <link rel="stylesheet" type="text/css" href="app-assets/css/pages/forgot.min.css">
      ...
      <div class="col s12">
        <div class="container"><div id="forgot-password" class="row">
            <div class="col s12 m6 l4 z-depth-4 offset-m4 card-panel border-radius-6 forgot-card bg-opacity-8">
                ...
                <div class="row">
                    <div class="input-field col s12">
                    <a href="dashboard.php" class="btn waves-effect waves-light border-round gradient-45deg-purple-deep-orange col s12 mb-1">Reset
                        Password</a>
                    </div>
                </div>
                <div class="row">
